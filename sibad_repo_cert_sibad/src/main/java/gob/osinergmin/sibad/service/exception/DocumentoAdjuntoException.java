...
public class DocumentoAdjuntoException extends BaseException {
     ...
     * @param exception
     */
    public DocumentoAdjuntoException(String codigo, Exception exception, boolean buscarCodigo) {		
     ...
     * @param exception
     */
    public DocumentoAdjuntoException(String codigo, String message, Exception exception) {		
