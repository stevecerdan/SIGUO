...
<html>
    <head>
        <script type="text/javascript" src='<c:url value="/javascript/app/repruebasCilindroGNV/frmReprogramacionCancelacion.js" />' charset="utf-8"></script>
<%--         <script type="text/javascript" src='<c:url value="/javascript/app/third-party/latinize.js"/>' charset="utf-8"></script> --%>
    </head>
    <body>
    	...
    	<fieldset>
	        <form id="frmCancelacion" class="tac">  
	            ...
	            <div class="form">
	                <div class="filaForm">
	                    <div class="lble vat"><label id="lblFecha" for="cmbMotivo">Fecha Cancelaci&oacute;n (*):</label></div>
                    ...
                    <div class="filaForm">
	                    <div class="lble vat"><label for="txtObservacion">Observaci&oacute;n (*):</label></div>
	                    <div>
        ...
        <div id="botones" style="margin-top:10px;text-align:center;">
        	<button id="btnCancelarProgramacion" title="Cancelar" class="btnSimple">Cancelar</button>
			<button id="btnGuardarProgramacion" title="Guardar" class="btnSimple">Guardar</button>
        </div>
    </body>
</html>