                        ...
                        <fieldset>
                            <form id="frmInspector" class="tac">
                                <div class="form" style="width:auto; float:left; margin-left: 15px;">
                                    ...
                                    <div class="filaForm">
                                        <div class="lble" style="width:93px;"><label for="lblSedeI">Sede:</label></div>
                                        <div class="slcta">
                                    ...
                                    <div class="filaForm">
                                        <div class="lble" style="width:93px;"><label for="txtEspecialidad">Especialidad:</label></div>
                                        <div class="slcta">
                                    ...
                                    <div class="filaForm">
                                        ...
                                        <input id="txtCIPI" class="ipt-medium" name="orden" type="text" maxlength="8" style="text-transform:uppercase;width: 362px;" onkeypress='return validaNumericos(event)'/>
                                    </div>
