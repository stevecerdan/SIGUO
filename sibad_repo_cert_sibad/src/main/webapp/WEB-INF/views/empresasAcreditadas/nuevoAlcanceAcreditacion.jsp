...
<html>
    ...
    <body>
                    ...
                    <div class="pui-panel-content ui-widget-content">
                        <fieldset>
                            ...
                            <form id="fileUploadForm" class="tac" method="post" enctype="multipart/form-data">
                                <div class="form" style="width:1020px; float:left; margin: 10px 0px 0px 10px;">
                                
                                    <div class="filaForm">
                                        <div class="lble" style="width:119px;"><label for="cmbTipoPrueba">Tipo de Prueba (*):</label></div>
                                        <div class="slcta">
                                    ...
                                    <input type="hidden" id="idOrganismoAcreditador"/>
                                    ...
                                    <div class="filaForm">
                                        <div class="lble" style="width:119px;"><label for="lblResolucion">Resoluci&oacute;n / Cedula (*):</label></div>
                                        <input id="txtResolucion" class="ipt-small" name="orden" type="text" maxlength="64" style="text-transform:uppercase;"/>
                                        
                                        <!-- SUBIR ARCHIVO -->
                                        <div class="lble" style="width:104px; margin-left:10px;"><label for="lblAdjuntarArchivo">Adjuntar Archivo (*):</label></div>
                                        <div class="customfile" style="border:2px solid #3B4959 ;position: absolute; width: 230px;">
								             <div class="innersec">
								                  ...
								                  <span class="cust-btn" style="margin-right:3px;">Adjuntar</span>
                                        ...
                                        <!-- SUBIR ARCHIVO -->
                                        <div class="lble" style="width:127px; margin-left:257px;"><label for="lblAdjuntarAlcance">Alcance de Acreditaci&oacute;n:</label></div>
                                        <div class="customfile" style="border:2px solid #3B4959 ;position: absolute; width: 230px;">
								             <div class="innersec">
								                  ...
								                  <span class="cust-btn" style="margin-right:3px;background-color: #002c53;">Adjuntar</span>
                                    ...
                                    <div class="fileForm">
	                                    <div class="gridMargin">
							                 <div id="gridContenedorDocAA" style="margin-left:25px;"></div>
							            </div>
							            <div class="gridMargin">
                                    ...
                                    <div class="filaForm">
                                        <div class="lble" style="width:119px;"><label for="cmbTipoOrganismo">Tipo de Organismo:</label></div>
                                        <div class="slcta" style="width:172px;">
                                        ...
                                        <div class="lble" style="width:104px; margin-left:2px;"><label for="lblNorma">Norma Evaluada:</label></div>
                                        <input id="txtNorma" class="ipt-medium-large" name="orden" type="text" maxlength="64" style="text-transform:uppercase; width:213px;"/>
                                    </div>
                                    
                                    <div class="filaForm">
                                        <div class="lble" style="width:140px;"><label for="lblFechaUA">Fecha de &Uacute;ltima Actualiza.:</label></div>
                                        <input id="txtFechaUA" class="ipt-medium" name="orden" type="text" maxlength="0" style="text-transform:uppercase; width:118px;"/>
                                        
                                        <div class="lble" style="width:104px; margin-left:11px;"><label for="lblFechaA">Fecha de Acredit.:</label></div>
                                        <input id="txtFechaA" class="ipt-medium-large" name="orden" type="text" maxlength="0" style="text-transform:uppercase; width:123px;"/>
                                    </div>
                                    
                                    <div class="filaForm">
                                        <div class="lble" style="width:140px;"><label for="lblFechaIV">Fecha de Inicio Vigencia (*):</label></div>
                                        <input id="txtFechaIV" class="ipt-medium" name="orden" type="text" maxlength="0" style="text-transform:uppercase; width:118px;"/>
                                        
                                        <div class="lble" style="width:104px; margin-left:11px;"><label for="lblFechaV">Fecha de Venc. (*):</label></div>
	                    ...
	                    <div id="botonesDerecha" style="margin: 5px 0px 5px 0px;">
						  	<input type="button" style="width:150px;" id="btnNuevaSede" title="Agregar Sede" class="btnSimple" value="Agregar Sede">
						  	<input type="button" style="width:150px;" id="btnNuevoPersonal" title="Nuevo Personal" class="btnSimple" value="Nuevo Personal">
						</div>
		...
		<div id="dialogPersonalSede" class="dialog"  title="AGREGAR PERSONAL AUTORIZADO" style="display:none;"></div>
		<div id="dialogInspectorAutorizado" class="dialog"  title="AGREGAR INSPECTOR AUTORIZADO" style="display:none;"></div>
		<div id="dialogInspectorAutorizado1" class="dialog"  title="EDITAR INSPECTOR AUTORIZADO" style="display:none;"></div>
