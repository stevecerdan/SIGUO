...
function validarPersonalI() {
	...
	if ($("#txtNumeroI").val() !== "") {
	    ...
	    $.ajax({
	        url:baseURL + "pages/solicitudPruebasHermeticidad/validarPersonal",
	        type:'post',
	        async:false,
	        data:{
...
function cargarDatosResultadoPN() {
    if(idRPersonaNaturalAux !== "" && idRPersonaNaturalAux !== undefined){
        ...
        $.ajax({
            url:baseURL + "pages/solicitudPruebasHermeticidad/cargarDatosResultadoPN",
            type:'post',
            async:false,
            data:{
...
function cargarTipoDocumentoI() {
    ...
    $.ajax({
        url:baseURL + "pages/solicitudPruebasHermeticidad/cargarComboTipo",
        type:'post',
        async:false,
        data:{
            dominio:encuentro,
...
function registrarPersonaNatural(){
  ...
  var tEvento = $("#tipoEvento").val();
    ...
    $.ajax({
        url:baseURL + "pages/solicitudPruebasHermeticidad/registrarPersonaNatural",
        type:'post',
        async:false,
        data:{
